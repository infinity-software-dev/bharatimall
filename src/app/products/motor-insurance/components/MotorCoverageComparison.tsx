  ...
  return (
    <section className="py-14 lg:py-20 bg-[#FFFFFF] border-t border-[#E5E5E0]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-[#FFFFFF] rounded-3xl shadow-xl border border-[#E5E5E0] overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[650px]">
              <thead>
                <tr className="border-b border-[#E5E5E0] bg-[#F5F5F3]">
                  <th className="py-6 px-6 sm:px-8 text-xs sm:text-sm font-bold text-[#171717] tracking-wider">
                    Features & Benefits
                  </th>
                  ...
                  <th className="py-6 px-4 text-center">
                    <div className="flex flex-col items-center gap-1.5">
                      <div className="w-8 h-8 rounded-full bg-[#F5F5F3] text-[#171717] flex items-center justify-center">
              ...
              <tbody className="divide-y divide-gray-100 text-xs sm:text-sm text-[#292929] font-medium">
                {comparisonData.map((row, idx) => (
                  <tr key={idx} className="hover:bg-[#F5F5F3] transition-colors">
                    <td className="py-4 px-6 sm:px-8 font-semibold text-[#171717]">
                      {row.feature}
                    </td>
                    ...
                    <td className="py-4 px-4 text-center">
                      {row.tp ? (
                        <CheckCircle2 className="w-5 h-5 text-[#171717] mx-auto" />
                      ) : (
