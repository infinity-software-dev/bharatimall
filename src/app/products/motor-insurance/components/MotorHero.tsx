      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#F5F5F3] border border-[#E5E5E0] text-[#171717] text-xs font-bold tracking-wide">
            ...
            <div className="pt-2 max-w-md">
              <div className="relative w-full aspect-[16/9] bg-gradient-to-br from-[#FFFDF5] to-[#FFF8D6] rounded-2xl border border-[#E5E5E0] p-4 flex items-center justify-center overflow-hidden shadow-inner">
                ...
                <div className="absolute top-3 right-5 z-10 bg-[#FFFFFF] rounded-lg border border-[#E5E5E0] p-2 shadow-md flex flex-col items-center">
                  <span className="text-[8px] font-black uppercase text-[#171717] bg-[#F5F5F3] px-1.5 py-0.5 rounded">POLICY</span>
                  <div className="w-6 h-0.5 bg-gray-200 my-1" />
                  <div className="w-5 h-0.5 bg-gray-200" />
                  <div className="w-4 h-4 rounded-full bg-[#F4C430] text-[#171717] flex items-center justify-center mt-1">
